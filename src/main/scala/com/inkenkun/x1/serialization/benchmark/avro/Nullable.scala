...
class Nullable extends Loop {
  ...
  lazy val adDatumWriter = new SpecificDatumWriter[AdRequestNullable](classOf[AdRequestNullable])
  lazy val adDatumReader = new SpecificDatumReader[AdRequestNullable](classOf[AdRequestNullable])
